...
{
	// Calculate the vector that separates the two objects and calculate the length of it
	...
	// Get collision radius of each char and accumulate them
	double combinedDistance = (character1->GetCollisionRadius() + character2->GetCollisionRadius());

	// Check whether distance is shorter than accumulated collision radii
